...
public class CameraFollowScript : MonoBehaviour {
    ...
    public Vector3 behindPosition = new Vector3(5, 15, -25);
    ...
    void FixedUpdate()
    {
        ...
        transform.rotation = Quaternion.Euler(new Vector3(angle, ourDrone.GetComponent<DroneMovementScript1>().CurrentYRotation, 0));
